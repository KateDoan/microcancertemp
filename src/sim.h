...
public:
    ...
    std::vector<double> read_csv_and_schedule_cancer(){
        ...
        CharacterVector vfname1 = sysfile("extdata", "pop_for_cancer.csv", Named("package", "microcancertemp"));
        std::string fname1 = as<std::string>(vfname1[0]);
        //Rcout << fname1 << "\n";
        CharacterVector vfname2 = sysfile("extdata", "birth_for_cancer.csv", Named("package", "microcancertemp"));
